                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" parsley-trigger="change" id="nopol" name="nopol" placeholder="Insert Car's Plate Number" required="" value="<?= $data_workshop->nopol ?>">
                                        </div>
                                    </div>
                                    <div class="col-md mb-3">
                                        <div class="form-group">
                                            <label>Customer Name<span style="color:red">*</span></label>
                                            <input type="text" class="form-control" parsley-trigger="change" id="customer_name" name="customer_name" placeholder="Insert Customer Name" required="" value="<?= $data_workshop->customer_name ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md text-end">
                                        <button type="button" class="btn btn-primary float-right" onclick="openModalAdd()">Add Data
